...
output = int(input("Please enter the amount of clothes the batch made: "))
price = int(input("Please enter the wholesale price for the batch in cents: "))
cost = int(input("Please enter the cost of the batch in cents: "))

# Send a transaction to confirm delivery
try:
    tx_hash = supplychain.functions.complete_batch(batch_id, output, price, cost).transact()
